...
<body style="background-color: #EFFEFF;">
    ...
    <main class="container" style="min-height: 60vh;">
        ...
        <button type="button" class="btn mb-3 text-white" style="background-color: #E07D54;" data-bs-toggle="modal" data-bs-target="#tambahModal">Tambah Pengguna</button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="user d-flex flex-column gap-2" action="../prosespengguna.php" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" placeholder="Nomor Telepon" name="no_telp" value="<?= $pengguna->no_telp ?>" required>
                                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-dark" href="../prosespengguna.php?aksi=hapus&id_pengguna=<?= $pengguna->id_pengguna ?>">Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="user d-flex flex-column gap-2" action="../prosespengguna.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Nomor Telepon" name="no_telp" required>
                        </div>
                        <div class="form-group">
