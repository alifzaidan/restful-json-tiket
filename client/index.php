...
// $pengguna = $abc->tampil_pengguna_byuser($username);
    ...
    <main class="container" style="min-height: 60vh;">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
            <?php foreach ($data_event as $event) : ?>
                <div class="col">
                    <a href="detail-event.php?id=<?= $event->id_event ?>" class="card shadow-lg text-decoration-none" style="min-height: 250px;">
                        <div class="card-body">
